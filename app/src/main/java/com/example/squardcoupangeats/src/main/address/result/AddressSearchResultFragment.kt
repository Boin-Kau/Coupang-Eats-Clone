...
class AddressSearchResultFragment : BaseFragment<FragmentAddressSearchResultBinding>(FragmentAddressSearchResultBinding::bind, R.layout.fragment_address_search_result) {
