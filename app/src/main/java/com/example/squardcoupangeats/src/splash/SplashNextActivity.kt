...
import com.example.squardcoupangeats.databinding.ActivitySplashNextBinding
import com.example.squardcoupangeats.src.main.MainActivity

class SplashNextActivity : BaseActivity<ActivitySplashNextBinding>(ActivitySplashNextBinding::inflate) {
